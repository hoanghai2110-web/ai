        ...
        <div className="flex justify-between">
          {isMobile ? (
            <button
              ...
              className="text-muted-foreground hover:text-foreground hover:bg-muted inline-flex size-9 items-center justify-center rounded-md bg-transparent transition-colors focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2"
            >
              <X size={24} />
            </button>
          ) : (
          ...
          <AnimatePresence mode="sync" initial={false}>
            {open && (
              ...
              >
                <HistoryTrigger
                  hasSidebar={false}
                  classNameTrigger="text-muted-foreground hover:text-foreground hover:bg-muted inline-flex size-9 items-center justify-center rounded-md transition-colors focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2"
